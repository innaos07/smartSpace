    ...
    <div class="container">
      <div class="deals__top d-flex flex-column flex-md-row justify-content-md-between" >
        <div class="deals__header d-flex flex-column">
          ...
          <p class="deals__sub-title">
            Colonel gravity get thought fat smiling add but. Wonder twenty
            <br />hunted and put income set desire expect.
          </p>
        </div>
      ...
      <div class="deals__center">
        <DealsTabBlock
          :deals__tabs="dealsTab"
          :isActive="isActive"
          @changeIsActive="changeIsActive($event)"
        />
      </div>
...
export default {
      ...
      dealsList: [
        {
          ...
          img: "home-01",
          id: 23,
          tag: "Residential Property, Commercial Property",
        },
        {
          linkOne: "#",
          linkTwo: "#",
          ...
          img: "home-02",
          id: 22,
          tag: "Residential Property, Agriculture Property, Commercial Property",
        },
        {
          linkOne: "#",
          linkTwo: "#",
          ...
          img: "home-03",
          id: 12,
          tag: "Residential Property. Agriculture Property",
        },
        {
          linkOne: "#",
          linkTwo: "#",
          ...
          img: "home-02",
          id: 45,
          tag: "Industrial Property. Agriculture Property",
        },
        {
          linkOne: "#",
          linkTwo: "#",
  ...
  computed: {
    filteredDealsList() {
      ...
      return this.dealsList.filter((item) => item.tag?.toUpperCase().includes(activeTags?.toUpperCase()));
    },
  },
};
</script>
